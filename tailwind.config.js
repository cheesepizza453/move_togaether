  ...
  theme: {
    extend: {
      ...
      fontSize:{
        ...
        '16-r': ['16px', { lineHeight: '1', 'letterSpacing': '-0.41px', fontWeight: '400' }],
        '14-r': ['14px', { lineHeight: '1', 'letterSpacing': '-0.41px', fontWeight: '400' }],
        '12-r': ['12px', { lineHeight: '1', 'letterSpacing': '-0.41px', fontWeight: '400' }],
        '10-r': ['10px', { lineHeight: '1', 'letterSpacing': '-0.41px', fontWeight: '400' }],
        '9-r': ['9px', { lineHeight: '1', 'letterSpacing': '-0.41px', fontWeight: '400' }],
        '14-l': ['14px', { lineHeight: '1', 'letterSpacing': '-0.41px', fontWeight: '300' }],
        '12-l': ['12px', { lineHeight: '1', 'letterSpacing': '-0.41px', fontWeight: '300' }],
        '10-l': ['10px', { lineHeight: '1', 'letterSpacing': '-0.41px', fontWeight: '300' }],
