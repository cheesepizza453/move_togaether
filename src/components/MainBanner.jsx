    ...
    <div className="relative w-full aspect-[356/188] rounded-[15px] overflow-hidden">
      ...
      {banners.length > 1 && (
        <div className="absolute bottom-[10px] right-[16px] flex items-center space-x-[2px] z-20">
          ...
          <button
            onClick={prevSlide}
            className="w-6 h-6 rounded-full flex items-center justify-center transition-all duration-200 shadow-sm backdrop-blur-sm bg-white/90 hover:bg-white text-yellow-500 hover:shadow-md"
            aria-label="이전 배너"
          >
