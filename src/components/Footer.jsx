...
const Footer = () => {
  return (
    <footer className="hidden lg:block bg-gray-50 border-t border-gray-200 mt-12 sm:mt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <ul className="space-y-1.5 sm:space-y-2">
              <li>
                <a href="/posts" className="text-gray-600 hover:text-blue-600 transition-colors text-xs sm:text-sm">
                  봉사 요청 보기
                </a>
              </li>
              <li>
                <a href="/posts/new" className="text-gray-600 hover:text-blue-600 transition-colors text-xs sm:text-sm">
                  봉사 요청 등록
                </a>
              </li>
              <li>
                <a href="/about" className="text-gray-600 hover:text-blue-600 transition-colors text-xs sm:text-sm">
                  서비스 소개
                </a>
              </li>
              <li>
                <a href="/contact" className="text-gray-600 hover:text-blue-600 transition-colors text-xs sm:text-sm">
                  문의하기
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="pt-3 sm:pt-4">
              <h4 className="font-medium text-gray-800 mb-2 text-sm sm:text-base">소셜 미디어</h4>
