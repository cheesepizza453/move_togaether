...
const BottomNavigation = () => {
  ...
  const tabs = [
    ...
    },
    {
      ...
      href: '/mypage',
      customIcon: (
        <svg width="100%" height="100%" viewBox="0 0 25 27" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
      <div className="fixed bottom-0 w-full h-full max-h-[93px] z-[10000] max-w-[550px] left-1/2 -translate-x-1/2">
        {/* 노란색 강조선 */}
          ...
          {tabs.map((tab) => {
            ...
            return (
                <button
                    ...
                    className={`flex flex-col items-center justify-center w-full pt-1 px-1 transition-all duration-200 ${
                        isActive
                            ? 'text-yellow-500'
                ...
                >
                  <div className={`relative transition-all duration-200 ${
                    ...
                    {tab.customIcon ? (
                        <div
                            className={`flex items-center justify-center w-[30px] h-[30px] ${isActive ? 'text-yellow-500' : 'text-gray-500'}`}>
                          {tab.customIcon}
                        </div>
                    ) : (
                        <Icon className={`transition-all duration-200 ${
                            isCircle
                                ? 'w-7 h-7'
                                : `w-[30px] h-[30px] ${isActive ? 'text-yellow-500 scale-110' : 'text-gray-500'}`
                        }`}/>
                    )}
                  </div>
                  {!isCircle && (
        ...
        <figure className="absolute w-full h-full">
          <MenuBar className={'shadow-[0_0_15px_0px_rgba(0,0,0,0.1)]'}/>
        </figure>
      </div>
  );
};
