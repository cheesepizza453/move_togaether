            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-[15px] py-[18px] pr-[50px] text-16-r rounded-[15px] border text-text-800 ${
                    errors.password
                ...
                <button
                  ...
                  className="absolute right-[15px] top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-gray-700 transition-colors"
                  disabled={loading}
                >
                  {showPassword ? (
