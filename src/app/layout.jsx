...
export const metadata = {
    ...
    openGraph: {
        ...
        images: [
            {
                url: 'https://move-togaether.com/img/og-image.jpg',
                width: 1200,
                height: 630,
    ...
    twitter: {
        ...
        title: '무브투개더 - 함께 움직여 마음을 잇다',
        description: '유기견이 새로운 삶을 향해 안전하게 이동할 수 있도록, 따뜻한 마음과 발걸음을 잇는 이동봉사 매칭 플랫폼입니다.',
        images: ['https://move-togaether.com/img/og-image.jpg'],
    },
    robots: {
        index: true,
        follow: true,
    ...
    other: {
        'og:title': '무브투개더 - 함께 움직여 마음을 잇다',
        'og:description':
            '유기견이 새로운 삶을 향해 안전하게 이동할 수 있도록, 따뜻한 마음과 발걸음을 잇는 이동봉사 매칭 플랫폼입니다.',
        'og:image': 'https://move-togaether.com/img/og-image.jpg',
        'og:image:width': '1200',
        'og:image:height': '630',
    },
};
