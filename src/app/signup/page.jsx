...
const SignupPage = () => {
  ...
  const hasConfirmPasswordError =
      ...
      (!confirmPassword && errors.confirmPassword === false);
            ...
            <div>
              ...
              <div className="relative">
                <input
                    ...
                    className={`w-full h-[54px] px-[18px] border rounded-[15px] focus:outline-none focus:ring-1 focus:ring-brand-main focus:border-transparent transition-colors ${
                        errors.email
                ...
                <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
                  {isCheckingEmail ? (
                      ...
                      <svg
                          className="w-5 h-5 text-brand-point"
                          fill="currentColor"
                          viewBox="0 0 20 20"
                      >
                        <path
              ...
              {/* 이메일 상태 메시지 */}
              {errors.email && (
                  <p className="mt-[6px] text-9-r text-brand-point">
                    {errors.email}
                  </p>
              )}
              ...
              {emailValidation && !errors.email && (
                  <p
                      className={`mt-[6px] text-9-r flex items-center ${
                          emailValidation.isValid
                              ? 'text-[#2BA03E]'
                              : 'text-brand-point'
                      }`}
              ...
              {password && (
                  <div className="mt-2">
                    <div className="flex items-center space-x-4">
                      <div
                          className={`text-9-r flex items-center ${
